...
$(document).ready(function(){
  $(".signup-link").click(function(){
    $("#signin_form, #signin_head").hide();
    $("#signup_form, #signup_head").show();
  });
  $(".signin-link").click(function(){
    $("#signup_form, #signup_head").hide();
    $("#signin_form, #signin_head").show();
  });
  $(".forgot-link").click(function(){
    $("#signin_form, #signin_head").hide();
    $("#forgot_form, #forgot_head").show();
  });
  $(".return-link").click(function(){
    $("#forgot_form, #forgot_head").hide();
    $("#signin_form , #signin_head").show();
  });
  ...
  $('#menu_button_div_cover').click( function(){
    if ( !toggled ) {
      menu.className = menu.className + " toggled";
      toggled = true;
  ...
  $('#menu_link_div').click(function(){
   ...
   menu.addEventListener('click', function() {
    ...
    $(".intro_").mouseenter(function(){
      $(".intro_").css({
        "border-bottom":"3px solid orange"
      });    
    });
    $(".intro_").mouseleave(function(){
      $(".intro_").css({
        "border-bottom":"0px solid orange"
      });
    });
    $(".regpro_").mouseenter(function(){
      $(".regpro_").css({
        "border-bottom":"3px solid orange"
      });
    });
    $(".regpro_").mouseleave(function(){
      $(".regpro_").css({
        "border-bottom":"0px solid orange"
      });
    });
    $(".rul_").mouseenter(function(){
      $(".rul_").css({
        "border-bottom":"3px solid orange"
      });
    });
    $(".rul_").mouseleave(function(){
      $(".rul_").css({
        "border-bottom":"0px solid orange"
      });
    });
    $(".prbst_").mouseenter(function(){
      $(".prbst_").css({
        "border-bottom":"3px solid orange"
      });
    });
    $(".prbst_").mouseleave(function(){
      $(".prbst_").css({
        "border-bottom":"0px solid orange"
      });
    });
    $(".contd_").mouseenter(function(){
     $(".contd_").css({
        "border-bottom":"3px solid orange"
      });
    });
    $(".contd_").mouseleave(function(){
      $(".contd_").css({
        "border-bottom":"0px solid orange"
      });
  });
